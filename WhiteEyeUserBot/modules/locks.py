...
@WhiteEye.on(WhiteEye_on_cmd("curenabledlocks", allow_sudo=True))
async def _(event):
...
@WhiteEye.on(events.MessageEdited())  # pylint:disable=E0602
@WhiteEye.on(events.NewMessage())  # pylint:disable=E0602
