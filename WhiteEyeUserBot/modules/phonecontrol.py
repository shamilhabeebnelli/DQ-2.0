...
@WhiteEye.on(WhiteEye_on_cmd(pattern="pmute ?(.*)", allow_sudo=True))
async def _(event):
    if event.fwd_from:
        return
    if not event.reply_to_msg_id:
...
@WhiteEye.on(WhiteEye_on_cmd(pattern="pring ?(.*)", allow_sudo=True))
async def _(event):
    if event.fwd_from:
        return
    if not event.reply_to_msg_id:
...
@WhiteEye.on(WhiteEye_on_cmd(pattern="pvibrate ?(.*)", allow_sudo=True))
async def _(event):
    if event.fwd_from:
        return
    if not event.reply_to_msg_id:
