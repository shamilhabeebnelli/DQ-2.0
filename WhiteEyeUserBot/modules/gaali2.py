...
@WhiteEye.on(WhiteEye_on_cmd(pattern="rapee ?(.*)"))
@WhiteEye.on(sudo_cmd(pattern="rapee ?(.*)", allow_sudo=True))
async def _(event):
    if event.fwd_from:
        return
...
@WhiteEye.on(WhiteEye_on_cmd(pattern="insultt ?(.*)"))
@WhiteEye.on(sudo_cmd(pattern="insultt ?(.*)", allow_sudo=True))
async def _(event):
    if event.fwd_from:
        return
...
@WhiteEye.on(WhiteEye_on_cmd(pattern="proo ?(.*)"))
@WhiteEye.on(sudo_cmd(pattern="proo ?(.*)", allow_sudo=True))
async def _(event):
    if event.fwd_from:
        return
...
@WhiteEye.on(WhiteEye_on_cmd(pattern="abusee ?(.*)"))
@WhiteEye.on(sudo_cmd(pattern="abusee ?(.*)", allow_sudo=True))
async def _(event):
    if event.fwd_from:
        return
...
@WhiteEye.on(WhiteEye_on_cmd(pattern="geyy ?(.*)"))
@WhiteEye.on(sudo_cmd(pattern="geyy ?(.*)", allow_sudo=True))
async def _(event):
    if event.fwd_from:
        return
