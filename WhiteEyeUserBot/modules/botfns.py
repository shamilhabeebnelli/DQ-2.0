...
@WhiteEye.on(WhiteEye_on_cmd(pattern="reader ?(.*)"))
@WhiteEye.on(sudo_cmd(pattern="reader ?(.*)", allow_sudo=True))
async def _(event):
    if event.fwd_from:
        return
    if not event.reply_to_msg_id:
...
@WhiteEye.on(WhiteEye_on_cmd(pattern="aud ?(.*)"))
@WhiteEye.on(sudo_cmd(pattern="aud ?(.*)", allow_sudo=True))
async def _(event):
    if event.fwd_from:
        return
    if not event.reply_to_msg_id:
...
@WhiteEye.on(WhiteEye_on_cmd(pattern="instadl ?(.*)"))
@WhiteEye.on(sudo_cmd(pattern="instadl ?(.*)", allow_sudo=True))
async def _(event):
    if event.fwd_from:
        return
    if not event.reply_to_msg_id:
...
@WhiteEye.on(WhiteEye_on_cmd(pattern="xogame$"))
@WhiteEye.on(sudo_cmd(pattern="xogame$", allow_sudo=True))
...
@WhiteEye.on(WhiteEye_on_cmd(pattern="whisper ?(.*)"))
@WhiteEye.on(sudo_cmd(pattern="whisper ?(.*)", allow_sudo=True))
...
@WhiteEye.on(WhiteEye_on_cmd(pattern="crack ?(.*)"))
@WhiteEye.on(sudo_cmd(pattern="crack ?(.*)", allow_sudo=True))
async def mod(event):
    if event.fwd_from:
        return
...
@WhiteEye.on(WhiteEye_on_cmd(pattern="checkspam ?(.*)"))
@WhiteEye.on(sudo_cmd(pattern="checkspam ?(.*), allow_sudo=True"))
async def _(event):
    bot = "@SpamBot"
    if event.fwd_from:
        return
...
async def _(event):
    ...
    async with event.client.conversation(chat) as conv:
        ...
        await x.edit(
            "Downloaded by [WhiteEye](t.me/WhiteEyeSupport), via @gitdownloadbot"
        )


@WhiteEye.on(WhiteEye_on_cmd(pattern="imusic ?(.*)"))
@WhiteEye.on(sudo_cmd(pattern="imusic ?(.*)", allow_sudo=True))
async def tel(event):
    if event.fwd_from:
        return
...
@WhiteEye.on(WhiteEye_on_cmd(pattern="font ?(.*)"))
@WhiteEye.on(sudo_cmd(pattern="font ?(.*)", allow_sudo=True))
async def _(event):
    bot = "@fontsgenbot"
    if event.fwd_from:
        return
