...
@WhiteEye.on(WhiteEye_on_cmd("leave$"))
async def leave(e):
...
@WhiteEye.on(WhiteEye_on_cmd(";__;$"))
...
@WhiteEye.on(WhiteEye_on_cmd("yo$"))
...
@WhiteEye.on(WhiteEye_on_cmd("Oof$"))
...
@WhiteEye.on(WhiteEye_on_cmd("ccry$"))
...
@WhiteEye.on(WhiteEye_on_cmd("fp$"))
...
@WhiteEye.on(WhiteEye_on_cmd("moon$"))
...
@WhiteEye.on(WhiteEye_on_cmd("source$"))
# @register(outgoing=True, pattern="^.source$")
async def source(e):
    if not e.text[0].isalpha() and e.text[0] not in ("/", "#", "@", "!"):
        await e.edit("https://github.com/mrdayamzaidi/WhiteEyeUserbot")


@WhiteEye.on(WhiteEye_on_cmd("readme$"))
# @register(outgoing=True, pattern="^.readme$")
async def reedme(e):
    if not e.text[0].isalpha() and e.text[0] not in ("/", "#", "@", "!"):
        await e.edit("https://github.com/mrdayamzaidi/WhiteEyeUSERBOT/blob/master/README.md")


@WhiteEye.on(WhiteEye_on_cmd("heart$"))
...
@WhiteEye.on(WhiteEye_on_cmd("fap$"))
...
CMD_HELP.update({"source": "Gives the source of your WhiteEyeUserBot"})
