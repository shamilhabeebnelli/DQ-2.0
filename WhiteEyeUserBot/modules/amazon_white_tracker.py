...
from WhiteEyeUserBot.modules.sql_helper.amazon_tracker_sql import add_new_tracker, is_tracker_in_db, rm_tracker, get_tracker_info, rm_tracker, get_all_tracker, get_all_urls
import requests
from bs4 import BeautifulSoup
from WhiteEyeUserBot.utils import WhiteEye_on_cmd

@WhiteEye.on(WhiteEye_on_cmd(pattern="amt"))
async def _(event):
    if event.fwd_from:
        return
...
@WhiteEye.on(WhiteEye_on_cmd(pattern="rmt"))
async def _(event):
    if event.fwd_from:
        return
