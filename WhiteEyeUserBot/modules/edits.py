...
@WhiteEye.on(WhiteEye_on_cmd(pattern=r"candy"))
async def _(event):
    if event.fwd_from:
        return
    deq = deque(list("🍦🍧🍩🍪🎂🍰🧁🍫🍬🍭"))
...
@WhiteEye.on(WhiteEye_on_cmd(pattern=r"nothappy"))
async def _(event):
    if event.fwd_from:
        return
...
@WhiteEye.on(WhiteEye_on_cmd(pattern=r"heart"))
async def _(event):
    if event.fwd_from:
        return
    deq = deque(list("❤️🧡💛💚💙💜🖤"))
...
@WhiteEye.on(WhiteEye_on_cmd(pattern=r"tlol"))
async def _(event):
    if event.fwd_from:
        return
    deq = deque(list("🤔🧐🤨🤔🧐🤨"))
...
@WhiteEye.on(WhiteEye_on_cmd(pattern=f"smoon", outgoing=True))
async def _(event):
...
# By @xditya. Kangers keep credits xD
@WhiteEye.on(WhiteEye_on_cmd(pattern=f"tmoon", outgoing=True))
async def _(event):
...
@WhiteEye.on(WhiteEye_on_cmd(pattern="loveu", outgoing=True))
async def _(event):
...
@WhiteEye.on(WhiteEye_on_cmd(pattern=f"plane", outgoing=True))
async def _(event):
    if event.fwd_from:
        return
...
@WhiteEye.on(WhiteEye_on_cmd(pattern=f"rain", outgoing=True))
async def _(event):
    if event.fwd_from:
        return
    deq = deque(list("🌬☁️🌩🌨🌧🌦🌥⛅🌤"))
...
@WhiteEye.on(WhiteEye_on_cmd(pattern=f"snake", outgoing=True))
async def _(event):
...
@WhiteEye.on(WhiteEye_on_cmd(pattern=f"solarsystem", outgoing=True))
async def _(event):
    if event.fwd_from:
        return
    animation_interval = 0.1
...
@WhiteEye.on(WhiteEye_on_cmd(pattern=r"bfly", outgoing=True))
async def _(event):
    if event.fwd_from:
        return
    deq = deque(list("🦋✨🦋✨🦋✨🦋✨"))
...
@WhiteEye.on(WhiteEye_on_cmd(pattern=f"virus", outgoing=True))
async def _(event):
...
@WhiteEye.on(WhiteEye_on_cmd(outgoing=True, pattern="lul"))
async def join(e):
...
@WhiteEye.on(WhiteEye_on_cmd(outgoing=True, pattern="yes"))
async def join(e):
...
@WhiteEye.on(WhiteEye_on_cmd(outgoing=True, pattern="gn"))
async def join(e):
...
@WhiteEye.on(WhiteEye_on_cmd(outgoing=True, pattern="gm"))
async def join(e):
    if "gmute" in e.text:
        return
    await e.edit(
...
@WhiteEye.on(WhiteEye_on_cmd(outgoing=True, pattern="like"))
async def join(e):
...
@WhiteEye.on(WhiteEye_on_cmd(pattern=r"plane", outgoing=True))
async def _(event):
    if event.fwd_from:
        return
...
@WhiteEye.on(WhiteEye_on_cmd(pattern=r"km_rain2", outgoing=True))
async def _(event):
    if event.fwd_from:
        return
...
@WhiteEye.on(WhiteEye_on_cmd(pattern=r"react (.*)", outgoing=True))
async def _(event):
    if event.fwd_from:
        return
    input_str = event.pattern_match.group(1)
...
@WhiteEye.on(WhiteEye_on_cmd(pattern="oof ?(.*)"))
async def _(event):
    if event.fwd_from:
        return
...
@WhiteEye.on(WhiteEye_on_cmd(pattern="hek ?(.*)"))
async def _(event):
    if event.fwd_from:
        return
    for _ in range(5):
...
@WhiteEye.on(WhiteEye_on_cmd(pattern="sed ?(.*)"))
async def _(event):
    if event.fwd_from:
        return
    for _ in range(4):
...
@WhiteEye.on(WhiteEye_on_cmd(pattern="repeat ?(.*)"))
async def _(event):
