...
@WhiteEye.on(WhiteEye_on_cmd(outgoing=True, pattern="(mmf|mms) ?(.*)"))
@WhiteEye.on(sudo_cmd(pattern="(mmf|mms) ?(.*)", allow_sudo=True))
async def memes(cat):
    if cat.fwd_from:
        return
...
@WhiteEye.on(WhiteEye_on_cmd(outgoing=True, pattern="ascii ?(.*)"))
@WhiteEye.on(sudo_cmd(pattern="ascii ?(.*)", allow_sudo=True))
async def memes(cat):
    if cat.fwd_from:
        return
...
@WhiteEye.on(WhiteEye_on_cmd(pattern="invert$", outgoing=True))
@WhiteEye.on(sudo_cmd(pattern="invert$", allow_sudo=True))
async def memes(cat):
    if cat.fwd_from:
        return
    reply = await cat.get_reply_message()
...
@WhiteEye.on(WhiteEye_on_cmd(outgoing=True, pattern="solarize$"))
@WhiteEye.on(sudo_cmd(pattern="solarize$", allow_sudo=True))
async def memes(cat):
    if cat.fwd_from:
        return
    reply = await cat.get_reply_message()
...
@WhiteEye.on(WhiteEye_on_cmd(outgoing=True, pattern="mirror$"))
@WhiteEye.on(sudo_cmd(pattern="mirror$", allow_sudo=True))
async def memes(cat):
    if cat.fwd_from:
        return
    reply = await cat.get_reply_message()
...
@WhiteEye.on(WhiteEye_on_cmd(outgoing=True, pattern="flip$"))
@WhiteEye.on(sudo_cmd(pattern="flip$", allow_sudo=True))
async def memes(cat):
    if cat.fwd_from:
        return
    reply = await cat.get_reply_message()
...
@WhiteEye.on(WhiteEye_on_cmd(outgoing=True, pattern="gray$"))
@WhiteEye.on(sudo_cmd(pattern="gray$", allow_sudo=True))
async def memes(cat):
    if cat.fwd_from:
        return
    reply = await cat.get_reply_message()
...
@WhiteEye.on(WhiteEye_on_cmd(outgoing=True, pattern="zoom ?(.*)"))
@WhiteEye.on(sudo_cmd(pattern="zoom ?(.*)", allow_sudo=True))
async def memes(cat):
    if cat.fwd_from:
        return
    reply = await cat.get_reply_message()
...
@WhiteEye.on(WhiteEye_on_cmd(outgoing=True, pattern="frame ?(.*)"))
@WhiteEye.on(sudo_cmd(pattern="frame ?(.*)", allow_sudo=True))
async def memes(cat):
    if cat.fwd_from:
        return
    reply = await cat.get_reply_message()
