...
USER_BOT_WARN_ZERO = "You Have Attempted To Spam Masters Inbox So In order To Avoid Over Spam , You Have Been Blocked By WhiteEyeUserBot"

botisnoob = Var.TG_BOT_USER_NAME_BF_HER
USER_BOT_NO_WARN = (
    "**Hello, This is WhiteEye PM Protection Service ⚠️**\n\n"
    f"`My Boss {DEFAULTUSER} is Busy Right Now !` \n"
    "**Please Choose A Reason For What You Have Came For** 👀 \n\n"
    f"**{CUSTOM_MIDDLE_PMP}**"
)
...
if Var.PRIVATE_GROUP_ID is not None:
    ...
    async def approve_p_m(event):
        ...
        APPROVED_PMs = "Current Approved Users\n"
...
async def hehehe(event):
    ...
    if event.is_private:
        if not pmpermit_sql.is_approved(chat.id):
            ...
            await borg.send_message(chat, "**User Detected As Developer Or My Owner. So AutoApproved**")
