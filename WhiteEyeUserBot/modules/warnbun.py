...
@WhiteEye.on(WhiteEye_on_cmd("warn2"))
async def _(event):
    if event.fwd_from:
        return
    mentions = (
...
@WhiteEye.on(WhiteEye_on_cmd("warn3"))
async def _(event):
    if event.fwd_from:
        return
...
@WhiteEye.on(WhiteEye_on_cmd("warn0"))
async def _(event):
    if event.fwd_from:
        return
...
@WhiteEye.on(WhiteEye_on_cmd("ocb"))
async def _(event):
    if event.fwd_from:
        return
...
@WhiteEye.on(WhiteEye_on_cmd("fw"))
async def _(event):
    if event.fwd_from:
        return
